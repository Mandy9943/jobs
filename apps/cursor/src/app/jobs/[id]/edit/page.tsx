...
export const metadata: Metadata = {
  title: "Editează anunțul de job | Cursor Directory",
  description:
    "Editează un anunț de job pe Cursor Directory și ajungi astăzi la peste 300k de dezvoltatori.",
};
...
export default async function Page({ params }: { params: Params }) {
      ...
      <div className="min-h-screen flex items-center justify-center p-4 w-full max-w-sm mx-auto">
        <div className="max-w-md w-full text-center -mt-32">
          <p className="text-md mt-4">
            Conectează-te pentru a edita un anunț de job <br />
  ...
  <h1 className="text-2xl mb-4">Editează anunțul de job</h1>
